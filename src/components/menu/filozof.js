    ...
    <div>
      ...
      <div className='bg'>
        ...
        <p style={{fontFamily:'Titillium Web', padding:'10px 70px 10px 70px',color:'#333333'}}>
          Friedrich Wilhelm Nietzsche, <label style={{color:'#ff0000'}}>Alman</label> bir filolog, filozof, şair, kültür eleştirmeni ve besteci nitelikleriyle tanımlanmaktadır. Din, ahlak, felsefe, bilim ve modern kültür konuları üzerine yoğunlaşmış, bu alanlarda metafor, aforizma, ironilerle dolu eleştirel yazılar yazmıştır.<label style={{color:'#ff0000'}}>Güç istenci, Tanrının ölümü, Üstinsan ve Bengi dönüş</label> gibi kavramlara kilitlenmiştir. Ve <label style={{color:'#ff0000'}} >Böyle Buyurdu Zerdüşt</label> isimli eseriyle hafızalara kazınmış olan dahinin hayat hikayesi de kendisi gibi etkileyicidir.
          <br/><br/>
          Garip bir anne ile anlaşamadığı bir kız kardeşe sahip Nietzsche’nin kadınlarla ilgili düşüncelerinde etkili olan sebep; ilk başta ailesindeki kadınlar olmuştur. Papaz olabilmek için teoloji ve filoloji okumaya başlayıp, daha sonra “tanrı öldü” diyerek eğitimine dil bilimi alanında tamamlamıştır. Hayatı boyunca <label style={{color:'#ff0000'}} >migren</label> ağrılarından muzdarip olmuş ve şehir şehir gezerek sağlığına iyi gelecek iklimi aramıştır. Ama baş ağrılarına rağmen, yazmaya devam etmiş, delirene kadar kalemi elinden bırakmamıştır.
          <br/><br/>
          <h3>Friedrich Nietzsche’nin Hayatı</h3>
          Nietzsche, Prusya Krallığında Saksonya eyaletindeki küçük bir kasabada <label style={{color:'#ff0000'}}>15 Ekim 1844</label>'te doğmuş. Bir papaz ve öğretmen olan Carl Ludwig Nietzsche ile Franziska Oehler’in ilk çocukları olarak dünyaya gelen Nietzsche’nin doğduğu gün, aynı zamanda Prusya Kralı IV. Frederick William’ın da doğum günü olduğu için adı Friedrick Wilhelm olarak belirlenmiş. Röcken Protestan Kilisesi’nde papaz olan babası ile <label style={{color:'#ff0000'}}>dindar</label> bir aileden gelen annesinin Nietzsche’den sonra iki çocukları daha olmuş. 1846’da doğan kız kardeşi Elisabeth Förster-Nietzsche ve 1848’de doğan erkek kardeşi Ludwig Joseph.
          <br/><br/>
