...
const Filozof = () => {
  return (
    <div>
      ...
      <div className='bg'>
        <h2 style={{fontSize:'40px' , fontWeight:'600' , fontFamily:'Poiret One', textAlign:'center',color:'#333333'}}>FRIEDRICH NIETZSCHE</h2>
        <p style={{fontFamily:'Titillium Web', padding:'10px 70px 10px 70px',color:'#333333'}}>
          Friedrich Wilhelm Nietzsche, <label style={{color:'#ff0000'}}>Alman</label> bir filolog, filozof, şair, kültür eleştirmeni ve besteci nitelikleriyle tanımlanmaktadır. Din, ahlak, felsefe, bilim ve modern kültür konuları üzerine yoğunlaşmış, bu alanlarda metafor, aforizma, ironilerle dolu eleştirel yazılar yazmıştır.<label style={{color:'#0066ff'}}>Güç istenci, Tanrının ölümü, Üstinsan ve Bengi dönüş</label> gibi kavramlara kilitlenmiştir. Ve <label style={{color:'#ff6633'}} >Böyle Buyurdu Zerdüşt</label> isimli eseriyle hafızalara kazınmış olan dahinin hayat hikayesi de kendisi gibi etkileyicidir.
          <br/><br/>
          Garip bir anne ile anlaşamadığı bir kız kardeşe sahip Nietzsche’nin kadınlarla ilgili düşüncelerinde etkili olan sebep; ilk başta ailesindeki kadınlar olmuştur. Papaz olabilmek için teoloji ve filoloji okumaya başlayıp, daha sonra “tanrı öldü” diyerek eğitimine dil bilimi alanında tamamlamıştır. Hayatı boyunca <label style={{color:'#0066ff'}} >migren</label> ağrılarından muzdarip olmuş ve şehir şehir gezerek sağlığına iyi gelecek iklimi aramıştır. Ama baş ağrılarına rağmen, yazmaya devam etmiş, delirene kadar kalemi elinden bırakmamıştır.
          <br/><br/>
          <h3>Friedrich Nietzsche’nin Hayatı</h3>
          Nietzsche, Prusya Krallığında Saksonya eyaletindeki küçük bir kasabada <label style={{color:'#31698a'}}>15 Ekim 1844</label>'te doğmuş. Bir papaz ve öğretmen olan Carl Ludwig Nietzsche ile Franziska Oehler’in ilk çocukları olarak dünyaya gelen Nietzsche’nin doğduğu gün, aynı zamanda Prusya Kralı IV. Frederick William’ın da doğum günü olduğu için adı Friedrick Wilhelm olarak belirlenmiş. Röcken Protestan Kilisesi’nde papaz olan babası ile <label style={{color:'#663399'}}>dindar</label> bir aileden gelen annesinin Nietzsche’den sonra iki çocukları daha olmuş. 1846’da doğan kız kardeşi Elisabeth Förster-Nietzsche ve 1848’de doğan erkek kardeşi Ludwig Joseph.
          <br/><br/>
          ...
          <br/><br/>  
          Pforta'da uygunsuz sayılan konuların peşinden koşma tutkusu ve eğilimi edinmişti. O zamanlar neredeyse hiç bilinmeyen şair Friedrich Hölderlin'in eserleriyle tanıştı. Hölderlin'den "en sevdiğim şair" diye bahsediyordu ve bir denemesinde bu çılgın şairin "en yüce düşüncelliğe" farkındalık getirdiğini yazıyordu.[10] Denemeyi gözden geçiren öğretmen ona iyi bir not verdi, ancak Nietzsche'nin gelecekte daha sağlıklı, daha duru ve daha "Alman" yazarlar üzerine eğilmesinin uygun olacağı yorumunu yaptı. Nietzsche ayrıca tuhaf, dinsiz ve genellikle sarhoş bir şair olan Ernst Ortlepp'i de tanıyordu; Ortlepp, genç Nietzsche ile tanıştıktan birkaç hafta sonra bir hendekte ölü bulundu, ancak onun Nietzsche'yi Richard Wagner'in yazılı eserleriyle ve müziğiyle tanıştıran kişi olması muhtemeldir.[11] Nietzsche, belki de Ortlepp'in etkisiyle Richter adında bir öğrenciyle birlikte okula sarhoş dönüp bir öğretmenle karşılaştı ve bu Nietzsche'nin sınıf birinciliğini kaybederek sınıf başkanlığının elinden alınmasıyla sonuçlandı.[12]
          <h3>Mezuniyet sonrası ilk yılları</h3>
          ...
          <br/><br/>  
          "Sonuç olarak insanların yolu ikiye ayrılıyor: huzur ve zevk diye didinip durmak istiyorsan, inan; hakikatin tutkunu olmak istiyorsan, sorgula..."[14]
          <br/><br/>
